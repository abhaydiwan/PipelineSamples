...
node {
  ...
  stage("create change request") {
    ...
    //def responseState = serviceNow_updateChangeItem serviceNowConfiguration: [instance: 'dev53461'], credentialsId: 'ad2298b0-fe86-4f89-9810-62360cc19939', serviceNowItem: [sysId: sysIdRes]
    //echo responseState //NEW
    }
